...
class VimeoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample['input_img2_HR'] = self.get_frame(m, f_st + self.half_frame_window_size, mode = 'HR' )
        random.seed(seed)
        if self.transform:
...
if __name__ == "__main__":
    data_path_corrupted = './Fall2018_Multi_warp/dataset/vimeo_septuplet/sequences_noise/'
    data_path_MDSR = './Fall2018_Multi_warp/dataset/vimeo_septuplet/sequences_upsampled_MDSR/'
    data_path_clean = './Fall2018_Multi_warp/dataset/vimeo_septuplet/sequences/'
    data_list_file = './Fall2018_Multi_warp/dataset/vimeo_septuplet/sep_trainlist.txt'
